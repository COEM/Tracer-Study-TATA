        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form  action="/admin/lowker/<?php echo $__env->yieldContent('editLowkerId'); ?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>

                    <?php $__env->startSection('editMethod'); ?>
                    <?php echo $__env->yieldSection(); ?>
                        <div class="form-group">
                            <label for="inputStandard" class="col-lg-3 control-label">Judul Lowongan Kerja</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="textArea2">Isi Lowongan Kerja</label>
                            <div class="col-lg-8">
